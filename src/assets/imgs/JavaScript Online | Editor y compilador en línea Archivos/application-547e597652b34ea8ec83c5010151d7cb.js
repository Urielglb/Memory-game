...
(function() {
  ...
  demo_codes = {
    ...
    'erlang': ["-module(main).\n-export([main/1]).\nmain([_]) ->\n", "%% ", "    ", "init:stop() .\n", "erlang", "main.erl", "io:format(\"" + hello_msg + "\"),\n"],
...
(function() {
  var ProjectsCreateOrShowCtrl, aceframe_content_resize, app, update_id;
  ...
  ProjectsCreateOrShowCtrl = function($scope, $rootScope, $window, $cookieStore, $timeout, $route, $location, $filter, $routeParams, $uibModal, storage, Language, Project, Favorite, FeaturedProject, Gist) {
    ...
    $scope.$watch('project.language', function(post, pre) {
      ...
      return $rootScope.title = $rootScope.languageTitle = Language.getTitle($rootScope.languageId);
    });
    ...
    $scope.get_output_url = function(project) {
      ...
      return ($location.protocol()) + "://out." + ($location.host()) + ":" + ($location.port()) + "/projects/" + project.uid + "/output." + (output_type_to_url_name(project.output_type));
    };
    ...
    $scope.aceOptions = {
      ...
      onLoad: function(_ace) {
        ...
        return session = _ace.getSession();
      }
    };
  ...
  app.controller('ProjectsCreateCtrl', function($scope, $rootScope, $window, $cookieStore, $timeout, $route, $location, $filter, $routeParams, $uibModal, storage, Language, Project, Favorite, FeaturedProject, Gist) {
    var main_filename;
    $scope.project = {};
  ...
  app.controller('ProjectsShowCtrl', function($scope, $rootScope, $window, $cookieStore, $timeout, $route, $location, $filter, $routeParams, $uibModal, storage, Language, Project, Favorite, FeaturedProject, Gist) {
...
(function() {
  ...
  app.config(function($routeProvider, $httpProvider, $locationProvider) {
    ...
    route = route.when("/", {
      ...
      templateUrl: '/assets/about-0c29c826bd850f4115473e8ef0dfc414.html'
    });
    ['', '/ja', '/en', '/es'].forEach(function(localePath) {
      ...
      return route = route.when(localePath + "/languages/php", {
        ...
        templateUrl: '/assets/projects/new-ff3b3df2179a6b49456fd0895107cc1f.html'
      });
    });
    route = route.when("/help", {
      controller: 'HelpCtrl',
      templateUrl: '/assets/help-37b4937a13adff870523da49464e35e8.html',
      title: 'Help'
    }).when("/terminal", {
      ...
      controller: 'ProjectsCreateCtrl',
      templateUrl: '/assets/projects/show_embed-f303224a612dbb3f3342f13135f6a655.html'
    }).when("/projects/new", {
      controller: 'ProjectsCreateCtrl',
      templateUrl: '/assets/projects/new-ff3b3df2179a6b49456fd0895107cc1f.html'
    }).when("/projects/e/:uid", {
      ...
      controller: 'ProjectsShowCtrl',
      templateUrl: '/assets/projects/show-ff3b3df2179a6b49456fd0895107cc1f.html'
    }).when("/gists/:gist_id", {
      controller: 'ProjectsShowCtrl',
      templateUrl: '/assets/projects/show-ff3b3df2179a6b49456fd0895107cc1f.html'
    }).when("/users/show/:id", {
